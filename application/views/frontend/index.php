			...
			<div class="col-full">
				...
				<div class="slideshow-container">
					...
					<div class="mySlides fade" style="width: 100%">
						...
						<img src="<?= base_url() ?>assets/frontend/images/sigaka/ptpnxi.jpg" style="width: 100%; height: 650px; margin: 0 auto">
						<div class="text" style="background-color: rgba(0, 0, 0, 0.7)"><b>PTPN XI</b>, Jl. Merak No.1, Krembangan Sel., Kec. Krembangan, Kota SBY, Jawa Timur 60175</div>
					</div>

					<div class="mySlides fade" style="width: 100%">
						<div class="numbertext" style="background-color: rgba(0, 0, 0, 0.7)">2 / 10</div>
						<img src="<?= base_url() ?>assets/frontend/images/sigaka/gb-1.jpg" style="width: 100%; height: 650px; margin: 0 auto">
						<div class="text" style="background-color: rgba(0, 0, 0, 0.7)"><b>Kantor</b>, PK Rosella Baru</div>
					</div>

					<div class="mySlides fade" style="width: 100%">
						<div class="numbertext" style="background-color: rgba(0, 0, 0, 0.7)">3 / 10</div>
						<img src="<?= base_url() ?>assets/frontend/images/sigaka/gb-2.jpg" style="width: 100%; height: 650px; margin: 0 auto">
						<div class="text" style="background-color: rgba(0, 0, 0, 0.7)"><b>Proses</b>, PK Rosella Baru</div>
					</div>

					<div class="mySlides fade" style="width: 100%">
						<div class="numbertext" style="background-color: rgba(0, 0, 0, 0.7)">4 / 10</div>
						<img src="<?= base_url() ?>assets/frontend/images/sigaka/gb-3.jpg" style="width: 100%; height: 650px; margin: 0 auto">
						<div class="text" style="background-color: rgba(0, 0, 0, 0.7)"><b>Proses</b>, PK Rosella Baru</div>
					</div>

					<div class="mySlides fade" style="width: 100%">
						<div class="numbertext" style="background-color: rgba(0, 0, 0, 0.7)">5 / 10</div>
						<img src="<?= base_url() ?>assets/frontend/images/sigaka/gb-4.jpg" style="width: 100%; height: 650px; margin: 0 auto">
						<div class="text" style="background-color: rgba(0, 0, 0, 0.7)"><b>Proses</b>, PK Rosella Baru</div>
					</div>

					<div class="mySlides fade" style="width: 100%">
						<div class="numbertext" style="background-color: rgba(0, 0, 0, 0.7)">6 / 10</div>
						<img src="<?= base_url() ?>assets/frontend/images/sigaka/gb-5.jpg" style="width: 100%; height: 650px; margin: 0 auto">
						<div class="text" style="background-color: rgba(0, 0, 0, 0.7)"><b>Proses</b>, PK Rosella Baru</div>
					</div>
	...
	<section id="contact" class="s-contact">
		...
		<div class="row">
			...
			<div class="col-full contact-main" data-aos="fade-up">
				<p>
					<a href="mailto:#0" class="contact-email">pkrosellabaru@gmail.com</a>
					<span class="contact-number">+62 8123456789</span>
				</p>
		...
		<div class="row">
			...
			<div class="col-five tab-full contact-secondary" data-aos="fade-up">
				...
				industri Persada Blok S No.6, Jarang Sari, Lolawang,<br>
				Kec. Ngoro, Kabupaten Mojokerto, Jawa Timur 61385<br>
				</p>
		...
		<div class="row">
			<div class="col-full cl-copyright">
				<span>
					...
					</script> All rights reserved | <a href="http://wikidevia.digtive.id/" target="_blank">Digtive</a> | Repost by <a href="https://github.com/moosya99" title="https://github.com/moosya99" target="_blank">Mochamat Syahri</a>
					<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
				</span>
			</div>
		</div>
