							...
							<tr>
								...
								<td>
									...
									<?php if ($this->session->userdata('session_hak_akses') == 'manajer') : ?>
										...
										<button class="btn btn-danger btn-sm  btn-bg-gradient-x-red-pink box-shadow-2 karyawan-hapus" data-toggle="modal" data-target="#hapus" value="<?= $value['karyawan_id'] ?>" title="Hapus data karyawan"><i class="ft-trash"></i></button>
									<?php endif; ?>
								</td>
							</tr>
						<?php
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<fieldset class="form-group floating-label-form-group">
					...
					<select name="bagian" id="basicSelect" class="form-control">
						<?php
						foreach ($bagian as $key => $value) :
						?>
							<option value="<?= $value['bagian_id'] ?>"><?= $value['bagian_nama'] ?></option>
						<?php
						endforeach;
						?>
					</select>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<fieldset class="form-group floating-label-form-group">
					...
					<input type="text" class="form-control" name="nama" id="lihat_nama" placeholder="Nama Karyawan" autocomplete="off" readonly>
				</fieldset>
				<fieldset class="form-group floating-label-form-group">
					<label for="lihat_tempat">Tempat Lahir</label>
					<input type="text" class="form-control" name="tempat_lahir" id="lihat_tempat" value="" placeholder="Tempat Lahir" autocomplete="off" readonly>
				</fieldset>
				<fieldset class="form-group floating-label-form-group">
					<label for="lihat_tl">Tanggal Lahir</label>
					<div class='input-group'>
						<input type="date" class="form-control" name="tanggal_lahir" id="lihat_tl" placeholder="Tanggal Lahir" autocomplete="off" readonly>
						<div class="input-group-append">
							<span class="input-group-text">
								<span class="ft-calendar"></span>
							</span>
				...
				<fieldset class="form-group floating-label-form-group">
					<label for="lihat_bagian_karyawan">Bagian</label>
				...
				<fieldset class="form-group floating-label-form-group">
					...
					<input type="number" class="form-control" id="lihat_nohp" name="nomor_hp" placeholder="Nomor HP" autocomplete="off" readonly>
				</fieldset>
				<fieldset class="form-group floating-label-form-group">
					<label for="lihat_norek">Nomor Rekening</label>
					<input type="number" class="form-control" id="lihat_norek" name="nomor_rekening" placeholder="Nomor rekening boleh kosong" autocomplete="off" readonly>
				</fieldset>
			</div>
			<div class="modal-footer">
				<input type="reset" class="btn btn-secondary btn-bg-gradient-x-red-pink" data-dismiss="modal" value="Tutup">
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<fieldset class="form-group floating-label-form-group">
					<label for="bagian">Bagian</label>
					<select name="bagian" id="bagian" class="select2 form-control" style="width: 100%">
						<?php
						foreach ($bagian as $key => $value) :
						?>
							<option value="<?= $value['bagian_id'] ?>"><?= $value['bagian_nama'] ?></option>
