					...
					<tbody>
						...
						?>
							<tr>
								...
								<td>
									<a href="<?= base_url('gaji/detail/' . $value['karyawan_id']) ?>" class="btn btn-success btn-sm  btn-bg-gradient-x-purple-blue box-shadow-2" data-toggle="tooltip" data-placement="top" title="Lihat detail"><i class="ft-eye"></i></a>
