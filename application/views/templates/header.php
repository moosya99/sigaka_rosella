...
<head>
	...
	<meta name="description" content="Sistem Informasi Penggajian PK Rosella Baru">
	<meta name="keywords" content="Sistem Informasi Penggajian PK Rosella Baru">
	<meta name="author" content="Jihad">
	<title><?= $title ?> - PK Rosella Baru</title>
	...
	<div class="main-menu menu-fixed menu-light menu-accordion d-print-none menu-shadow " data-scroll-to-active="true" data-img="<?= base_url() ?>assets/images/backgrounds/02.jpg">
		<div class="navbar-header">
			<ul class="nav navbar-nav flex-row">
				<li class="nav-item mr-auto"><a class="navbar-brand" href="<?= base_url('dashboard') ?>">
						...
						<h3 class="brand-text">PK Rosella Baru</h3>
					</a></li>
		...
		<div class="main-menu-content">
			<ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
				...
				<li class=" nav-item <?php if ($this->uri->segment(1) == 'absen') echo 'active' ?>"><a href="<?= base_url('absen') ?>"><i class="ft-user-check"></i><span class="menu-title" data-i18n="">Absen</span></a>
				</li>
				...
				<li class=" nav-item <?php if ($this->uri->segment(1) == 'pinjam') echo 'active' ?>"><a href="<?= base_url('pinjam') ?>"><i class="ft-calendar"></i><span class="menu-title" data-i18n="">Pinjaman</span></a>
				</li>
